...
- `app/`: web app source code, Vite configuration, and tests.
  ...
  - `app/src/app/`: application controllers for selection, context menus, row editing, modals, row labels, persistence, import/export, arrows/expansion, plus transient session types.
